			...
			return new Promise(function(fnResolve) {
				...
				oManifestModel.attachRequestCompleted(function ()  {
					var oUriParameters = UriParameters.fromQuery(window.location.search),
						...
						// APS oMainDataSource = oManifestModel.getProperty("/sap.app/dataSources/mainService"),
						// APS sMetadataUrl = sap.ui.require.toUrl(_sAppPath + oMainDataSource.settings.localUri),
						// ensure there is a trailing slash
						// APS sMockServerUrl = /.*\/$/.test(oMainDataSource.uri) ? oMainDataSource.uri : oMainDataSource.uri + "/";
